var chosen={appTexts:{noResults:"Ingen resultater for ",placeholderSingle:"Vælg en option",placeholderMulti:"Vælg en eller flere"},init:function(){
//Set the chosen plugin (smarter select boxes)
$(".chosen-select").length>0&&$(".chosen-select").chosen({width:"100%",search_contains:!0,single_backstroke_delete:!1,no_results_text:chosen.appTexts.noResults,placeholder_text_single:chosen.appTexts.placeholderSingle,placeholder_text_multiple:chosen.appTexts.placeholderMulti})}};$(document).ready(function(){chosen.init()}),/*!
